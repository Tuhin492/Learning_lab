...
// Microsoft Office MCQ | No.19| Computer Awareness MCQ for FSSAI -FSO, Technical Officer & Assistant (Jan 5, 2022)
{ // 10
    question: "End key is used to",
    answers: ["Move the cursor beginning of the document", "Move the cursor end of the line", "Move the cursor beginning of the paragraph", "Move the cursor beginning of the line"],
    correct: "Move the cursor end of the line"
},
{ // 9
    question: "\u0022Ctrl+Right arrow\u0022 is used to",
    answers: ["Move the cursor one word right", "Move the cursor end of the line", "Move the cursor end of the document", "Move the cursor one paragraph down"],
    correct: "Move the cursor one word right",
    description: "\u0022Ctrl+Right arrow\u0022 is used to move the cursor one word right at a time while \u0022Ctrl+Left arrow\u0022 is used to move the cursor one word left at a time."
},
{ // 8
    question: "Home key uses for",
    answers: ["Move the cursor beginning of the document ", "Move the cursor beginning of the screen", "Move the cursor beginning of the paragraph", "Move the cursor beginning of the line"],
    correct: "Move the cursor beginning of the line"
},
{ // 7
    question: "Autocorrect was specially designed to replace ____ word as you type",
    answers: ["Short, repetitive", "Font case", "Misspelled", "None"],
    correct: "Misspelled",
    description: "Misspelled words will automatically be corrected while typing with Autocorrect feature."
},
{ // 6
    question: "When the language bar is ______ it means that you do not see it on the screen but it will be displayed the next time you start the computer",
    answers: ["Restored", "Minimize", "Hidden", "Closed"],
    correct: "Hidden"
},
{ // 5
    question: "In word 2003 which can be used for quick access to commonly used commands and tools",
    answers: ["Status bar", "Tool bar", "Menu bar", "Title bar"],
    correct: "Tool bar"
},
{ // 4
    question: "What is gutter Margin",
    answers: ["Margin that is added to the left margin when printing", "Margin that is added to right margin when printing", "Margin that is added to the binding side of page when printing", "Margin that is added to the outside of the page when printing"],
    correct: "Margin that is added to the binding side of page when printing",
    description: "The gutter margin is a typographical term used to designate an additional margin added to a page layout to compensate for the part of the paper made unusable by the binding process. In a facing pages layout (Word refers to this type of layout as \u0022mirror margins\u0022), the gutter margin is on the very inside of both pages."
},
{ // 3
    question: "A word processor is used to",
    answers: ["Keep an account of money spent", "Do a computer search in media center", "Maintain an inventory", "Type a story"],
    correct: "Type a story",
    description: "A word processor, or word processing program, does exactly what the name implies. It is used to manipulate a text document, such as a resume or a report. We typically enter text by typing, and the software provides tools for copying, deleting and various types of formatting."
},
{ // 2
    question: "Which enables us to send same Letter to different person",
    answers: ["Macros", "Template", "Mail Merge", "None of the above"],
    correct: "Mail Merge",
    description: "Mail Merge is a useful tool that allows us to produce multiple letters, label, envelopes, name tags, and more using information stored in a list, database, or spreadsheet."
},
{ // 1
    question: "The ability to combine name and addresses with a standard document is called",
    answers: ["Document formatting", "Database management", "Mail merge", "Form letter"],
    correct: "Mail merge",
    description: "The automatic addition of names and addresses from a database to letters and envelopes in order to facilitate sending mail, especially advertising, to many addresses."
},


// Computer Operating System MCQ | No.20 | FSSAI Computer Literacy MCQ CFSO ,TO & Assistant Exam (Jan 10, 2022)
{ // 10
    question: "Which of the following is a single-user operating system?",
    answers: ["Windows", "MAC", "MS-DOS", "None of these"],
    correct: "MS-DOS",
    description: "MS-DOS (Microsoft Disk Operating System) is a single-user, single-tasking operating system, meaning only one user and one task can be executed at a time.<br><br>In contrast:<br>Windows and Mac (macOS) are multi-user, multitasking operating systems."
},
{ // 9
    question: "Which is the Linux operating system?",
    answers: ["Private operating system", "Windows operating system", "Open-source operating system", "None of these"],
    correct: "Open-source operating system",
    description: "The Linux OS is an open-source operating system made up of a kernel. It is a very safe operating system."
},
{ // 8
    question: "What is the mean of the Booting in the operating system?",
    answers: ["Restarting computer", "Install the program", "To scan", "To turn off"],
    correct: "Restarting computer",
    description: "Booting is a process of the restart the computer. After restarting it, there is no software in the computer's main memory."
},
{ // 7
    question: "BIOS is used?",
    answers: ["By operating system", "By compiller", "By interpreter", "By application software"],
    correct: "By operating system",
    description: "BIOS (Basic Input/Output System) is firmware stored on a chip on the motherboard. It initializes hardware components and loads the operating system during boot-up. The OS interacts with BIOS to communicate with hardware at a low level."
},
{ // 6
    question: "What is the full name of FAT?",
    answers: ["File attribute table", "File allocation table", "Font attribute table", "Format allocation table"],
    correct: "File allocation table",
    description: "FAT (File Allocation Table) is a file system used in older operating systems like MS-DOS and early versions of Windows. It keeps track of file locations on a storage device. Variants include FAT12, FAT16, and FAT32. A FAT of the contents of a computer disk indicates which field is used for which file."
},
{ // 5
    question: "What else is a command interpreter called?",
    answers: ["Prompt", "Kernel", "Shell", "Command"],
    correct: "Shell",
    description: "A command interpreter is also called a shell because it acts as an interface between the user and the operating system, processing commands and executing them. Examples include Command Prompt (cmd.exe) in Windows, Bash in Linux, and Shell in DOS."
},
{ // 4
    question: "Which of the following is not application software?",
    answers: ["Windows 7", "WordPad", "Photoshop", "MS-excel"],
    correct: "Windows 7",
    description: "Windows 7 is an operating system"
},
{ // 3
    question: "What is the maximum length of the filename in DOS?",
    answers: ["4", "5", "8", "12"],
    correct: "8",
    description: "In DOS (Disk Operating System), the maximum length of a filename is 8 characters, followed by a 3-character file extension (e.g., FILENAME.TXT). This is known as the 8.3 filename format."
},
{ // 2
    question: "Which of the following is not an operating system?",
    answers: ["Windows", "Linux", "Oracle", "DOS"],
    correct: "Oracle",
    description: "Oracle is a famous technology company that creates databases, cloud services, and enterprise software. Its most well-known product is the Oracle Database, which helps store and manage large amounts of data for businesses. Oracle also provides cloud computing, server hardware, and business applications.<br><br>In short, Oracle helps companies handle data efficiently, whether on their own computers or in the cloud."
},
{ // 1
    question: "When was the first operating system developed?",
    answers: ["1948", "1949", "1950", "1951"],
    correct: "1950",
    description: "The first operating system was developed in the early 1950's. It was also called a single-stream batch processing system because it presented data in groups."
},


// Microsoft PowerPoint MCQ |No.21| FSSAI Computer Literacy MCQ ( Jan 14, 2022)
{ // 10
    question: "In PowerPoint, the objects on the slide used to hold the text are called as-",
    answers: ["Placeholders", "Textbox", "Text holders", "None of the above"],
    correct: "Placeholders",
    description: "Thea areas enclosed by the dotted borders on the slides are called Placeholders. Simply, you can say that placeholder is the enclosed areas on the slide. A placeholder is used to hold the text on the slide. It is a container that can hold text, image, graphics, table, video or audio clip, and anything you want to add into the slide."
},
{ // 9
    question: "Which of the following is the shortcut key to open the existing presentation in the powerpoint?",
    answers: ["Ctrl+M", "Ctrl+N", "Ctrl+O", "Ctrl+K"],
    correct: "Ctrl+O"
},
{ // 8
    question: "Which of the following is the default standard layout in PowerPoint?",
    answers: ["Blank slide", "Title and content slide", "Title slide", "None of the above"],
    correct: "Title slide"
},
{ // 7
    question: "What we have to type in the Run dialog box to open PowerPoint?",
    answers: ["Powerpoint", "PowerPoint", "Pwrpoint", "Powerpnt"],
    correct: "Powerpnt",
    description: "We can open the PowerPoint by typing the word <b>Powerpnt</b> in the run dialog box. The window+R shorcut key is used to open the run dialog box."
},
{ // 6
    question: "Which of the following is the shortcut key to insert a new slide between the current presentation?",
    answers: ["Ctrl+N", "Ctrl+K", "Ctrl+M", "Ctrl+O"],
    correct: "Ctrl+M"
},
{ // 5
    question: "Which of the following shortcut key is used to start the slideshow?",
    answers: ["Using F5 key", "Using F3 key", "Using F1 key", "Using F6 key"],
    correct: "Using F5 key"
},
{ // 4
    question: "In a presentation of PowerPoint, the special effects used to introduce slides are known as-",
    answers: ["Custom Animation", "Transitions", "Annotations", "None of the above"],
    correct: "Transitions",
    description: "Transition effects appear when one slide changes into the next slide in ta Slide Show. MS PowerPoint offers several types of transitions, which makes the presentation attractive and effective. When you add a transition  on a slide, the slide changes in a different way rather than simple."
},
{ // 3
    question: "Which of the following is called as page to create a presentation in PowerPoint?",
    answers: ["Sheet", "Slide", "Paper", "None of the above"],
    correct: "Slide"
},
{ // 2
    question: "Which of the following is the file extension of the PowerPoint application?",
    answers: [".ppt", ".jpg", ".html", ".docs"],
    correct: ".ppt"
},
{ // 1
    question: "What is a Microsoft PowerPoint?",
    answers: ["Spreadsheet Program", "Presentation Program", "Database Program", "All of the above"],
    correct: "Presentation Program"
},


// MS PowerPoint MCQ| No.22| FSSAI Computer Literacy MCQ | CFSO ,TO & Assistant Exam (Jan 15, 2022)
{ // 10
    question: "In which of the following menu, the slide sorter view is available in powerpoint?",
    answers: ["Insert", "View", "Design", "Animations"],
    correct: "View"
},
{ // 9
    question: "Which of the following feature of powerpoint allows us to quickly create a simple presentatin?",
    answers: ["Chart Wizard", "Auto content wizard", "Transition wizard", "None of the above"],
    correct: "Auto content wizard",
    description: "Auto Content Wizard provides the sample content to its users. On the other side, slide Design is a simple design format of PowerPoint that does not provide any sample content."
},
{ // 8
    question: "Which of the following is used to see all slides at once?",
    answers: ["Using slide sorter view", "Using slide view", "Using normal view", "None of the above"],
    correct: "Using slide sorter view",
    description: "Slide Sorter view is a view to see the slides presentation in a shorter view. It allows the users to see all the slides in a single view. Slide Sorter View makes it easy for the users to sort and organize the slides in a sequence if they want to print their slides. You can get this slide sorter view near the Reader View option in the toolbar section."
},
{ // 7
    question: "What is the motion path in powerpoint?",
    answers: ["A path from where the powerpoint program installed", "A method of moving the objects on a slide", "Both", "Neither"],
    correct: "A method of moving the objects on a slide",
    description: "A motion path is a method of moving objects on a slide. Powerpoint allows its users to add motion to an object in the slide, You can add motion to an object from the Animation tab by selecting an object."
},
{ // 6
    question: "What is the shortcut key to insert a hyperlink in the slide?",
    answers: ["Ctrl+H", "Ctrl+K", "Ctrl+A", "Not possible to insert hyperlinks"],
    correct: "Ctrl+K",
    description: "Pressing Ctrl+K will directly take you to the Insert Hyperlink window, where you have to choose a file you would like to make a hyperlink."
},
{ // 5
    question: "Which of the following option is correct to insert the chart as part of the powerpoint presentation?",
    answers: ["Insert>Chart", "Edit>Chart", "View>Chart", "All of the above"],
    correct: "Insert>Chart"
},
{ // 4
    question: "Which of the following fill effects can be used to fill the background of the slide?",
    answers: ["Picture", "Gradient", "Texture", "All of the above"],
    correct: "All of the above"
},
{ // 3
    question: "Is it possible to apply the same transition on all slides in a powerpoint presentation?",
    answers: ["True", "False"],
    correct: "True"
},
{ // 2
    question: "In PowerPoint, is it allowed to make a PDF of the PowerPoint Presentation?",
    answers: ["True", "False"],
    correct: "True",
    description: "Yes, you can make the PDF of the PowerPoint presentation. PowerPoint allows the users to convert the PowerPoint slides to PDF documents."
},
{ // 1
    question: "Which of the following command in powerpoint is used to bring the user directly to the first slide of the presentation?",
    answers: ["Ctrl+Home", "Alt+Home", "Shift+Home", "Home"],
    correct: "Ctrl+Home",
    description: "Ctrl+Home jumps to the first slide while Ctrl+End jumps to the last slide"
},


// Computer Literacy MCQ | No.23| FSSAI MCQ for CFSO , Technical Officer and Assistant Exam ( Jan 17, 2022)
{ // 10
    question: "Super computers are mainly useful for",
    answers: ["Mathematical intensive scientific applications", "Data-retrieval operations", "Input-output intensive processing", "All of the above"],
    correct: "Mathematical intensive scientific applications",
    description: "A supercomputer is a computer with a high level of performance compared to a general-purpose computer. Performance of a supercomputer is measured in floating-point operations per seconds (FLOPS) instead of million instructions per second (MIPS)."
},
{ // 9
    question: "When was the first e-mail sent?",
    answers: ["1963", "1969", "1971", "1974"],
    correct: "1971",
    description: "Sent by computer engineer Ray Tomlinson in 1971, the email was simply a test message to himself. The email was sent from one computer to another computer sitting right beside it in Cambridge."
},
{ // 8
    question: "The processor which performs arithmetical and logical operations is called",
    answers: ["Control", "ALU", "Register", "Cache memory"],
    correct: "ALU",
    description: "An arithmetic logic unit (ALU) is a digital circuit used to perform arithmetic and logic operations. It represents the fundamental building block of the central processing unit (CPU) of a computer. Modern CPUs contain very powerful and complex ALUs."
},
{ // 7
    question: "Graphical pictures that represent and object like file, folder etc are:",
    answers: ["Task bar", "Windows", "Icons", "Desktop"],
    correct: "Icons"
},
{ // 6
    question: "GUI stands for ______",
    answers: ["Graphical User Interface", "Graphical User Interactive", "Graphical User Integration", "Graphical User Inference"],
    correct: "Graphical User Interface",
    description: "GUI stands for Graphical User Interface. A Graphical User Interface is a computer interface that allows users to interact with a device through graphical elements such as pictures and animations, as opposed to text-based commands."
},
{ // 5
    question: "Portable program means?",
    answers: ["Independent from its authors", "Independent of platform", "Program with wheels", "None of the above"],
    correct: "Independent of platform",
    description: "Platform independence means that the same program works on any platform (OS) without needing any modification. IN the case of Java, the application runs in a Java Virtual Machine which itself isn't platform independent."
},
{ // 4
    question: "First generation of computer was based on which technology?",
    answers: ["Transistor", "VLSI", "Vaccum Tube", "None of these"],
    correct: "Vaccum Tube",
    description: "The first generation computer used vacuum tubes for circuitry and magnetic drums for memory, and were often enormous, taking up entire rooms. They were very expensive to operate and in addition to using a great deal of electricity, generated a lot of heat.<br><br>UNIVAC and ENIAC computers are examples of first-generation computing devices."
},
{ // 3
    question: "Fifth generation computers are based on ",
    answers: ["Artificial Intelligence", "Programming Intelligence", "System Knowledge", "VVLSI"],
    correct: "Artificial Intelligence",
    description: "Fifth generation computing devices, based on artificial intelligence, are still in development, though there are some applications, such as voice recognition, that are being used today. The use of parallel processing and superconductors is helping to make artificial intelligence a reality."
},
{ // 2
    question: "In how many generations a computer can be classified? <i>[Time-sensitive question]</i>",
    answers: ["3", "4", "5", "6"],
    correct: "5",
    description: "There is 5 generation of computer available till now<br><br>1st generation of computer = Vacuum tube based<br>2nd generation of computer = Transistor based<br>3rd generation of computer = Integrated circuit based<br>4th generation of computer = VLSI microprocessor based<br>5th generation of computer = ULSI microprocessor based."
},
{ // 1
...
// MS Excel MCQ | No.24| FSSAI Microsoft office MCQ| FSSAI CFSO,TO & Assistant Exam (Jan 20, 2022)
{ // 10
    question: "In MS Excel multiple calculation can be made in a single formula using",
    answers: ["Standard formulas", "Array formula", "Complex formulas", "Smart formula"],
    correct: "Array formula",
    description: "An array formula is a formula that can perform multiple calculations on one or more of the items in an array. We can think of an array as a row of values, a column of values, or a combination of rows and columns of values."
},
{ // 9
    question: "In MS Excel how can you find specific information in a list",
    answers: ["Select Tools > Finder from the menu", "Click the Find button on the standard toolbar", "Select Insert > Find from the menu", "Select Data > Form from the menu to open the Data Form dialog box and click the Criteria button"],
    correct: "Select Data > Form from the menu to open the Data Form dialog box and click the Criteria button"
},
{ // 8
    question: "To center worksheet title across a range of cell you must",
    answers: ["Select the cells containing the title text plus the range over which the title text is to be centered", "Widen the columns", "Select the cells containing the title text plus the range over which the title text is to be enfettered", "Format the cells with the comma style"],
    correct: "Select the cells containing the title text plus the range over which the title text is to be centered"
},
{ // 7
    question: "To create a formula in ms excel you first",
    answers: ["Select the cell you want to place the formula into", "Type the equals sigh (=) to tell Excel that you're about to enter a formula", "Enter the formula using any input values and the appropriate mathematical operators that make up your formula", "Choose the new command from the file menu"],
    correct: "Type the equals sigh (=) to tell Excel that you're about to enter a formula"
},
{ // 6
    question: "How do you select an entire columns in ms excel",
    answers: ["Select Edit>Select>Column from the menu", "Click the column heading letter", "Hold down the shift key as you click anywhere in the column", "Hold down the Ctrl key as you click anywhere in the column"],
    correct: "Click the column heading letter",
    description: "To select an entire column in Ms Excel, click the column heading letter or press Ctrl+Space bar key."
},
{ // 5
    question: "Which of the following methods cannot be used to enter data in a cell",
    answers: ["Pressing an arrow key", "Pressing the Tab key", "Pressing the Esc key", "Clicking on the formula bar"],
    correct: "Pressing the Esc key",
    description: "Pressing the Esc key while editing a cell aborts the operation and leaves the cell in it's original state."
},
{ // 4
    question: "The cancel and Enter button appear in the ____ of ms excel",
    answers: ["Title bar", "Formula bar", "Menu bar", "Sheet tabs"],
    correct: "Formula bar",
    description: "Three buttons Cancel, Enter, and Function wizard appear in the Formula bar."
},
{ // 3
    question: "B7:B9 indicates",
    answers: ["Cell B7 and Cell B9 only", "Cells B7 through B9", "Cell B8 only", "None of the above"],
    correct: "Cells B7 through B9",
    description: "B7:B9 indicates a range of cell between cells B7 through B9."
},
{ // 2
    question: "Which function of MS excel is used to calculate depreciation, rates of return, future value and loan payment amount",
    answers: ["Logical", "Math and Trigonometry", "Statistical", "Financial"],
    correct: "Financial"
},
{ // 1
    question: "The active cell of MS excel is",
    answers: ["A. Is defined by a bold border around the cell", "B. Receives the data the user enters", "C. It is the formula bar", "D. Only A and B"],
    correct: "D. Only A and B",
    description: "An active cell is a rectangular box that highlights (a bold border around) the cell in a spreadsheet. An active cell helps identify what cell is being worked with and where data will be entered."
},


// Computer Literacy MCQ | MCQ No. 25| FSSAI Exam Preparation | CFSO ,TO & Assistant (Feb 14, 2022)
{ // 10
    question: "Which button do you click to add up a series of numbers?",
    answers: ["The autosum button", "The Formula button", "The quicktotal button", "The total button"],
    correct: "The autosum button"
},
{ // 9
    question: "A computer is accurate, but if the result of a computation is false, what is the main reason for it?",
    answers: ["Power failure", "The computer circuits", "Incorrect data entry", "Distraction"],
    correct: "Incorrect data entry"
},
{ // 8
    question: "Which of the following is an output device?",
    answers: ["Keyboard", "Mouse", "Light pen", "VDU"],
    correct: "VDU"
},
{ // 7
    question: "Which of the following programs enables you to calculate numbers related to rows and columns?",
    answers: ["Window program", "Spreadsheet program", "Graphics program", "Word program"],
    correct: "Spreadsheet program"
},
{ // 6
    question: "Which of the following is the smallest visual element on a video monitor?",
    answers: ["Character", "Pixel", "Byte", "Bit"],
    correct: "Pixel"
},
{ // 5
    question: "How is the data stored on the diskette?",
    answers: ["Ink", "Laser bubbles", "Magnetism", "Circuits"],
    correct: "Magnetism",
    description: "The data is stored on the diskette in magnetism form. A diskette is a removable data storage, and it is used with the PC."
},
{ // 4
    question: "How many color dots make up one color pixel on a screen?",
    answers: ["265", "16", "8", "3"],
    correct: "3",
    description: "Three color dots form a color pixel on a screen, and these are the following color dots: red, blue and green. You can make any color from these 3 colors on the screen."
},
{ // 3
    question: "What is the term for a temporary storage area that compensates for differences in data rate flow between devices?",
    answers: ["Buffer", "Bus", "Chennel", "Modem"],
    correct: "Buffer",
    description: "Buffer is the temporary storage that can be used to compensate for a difference in data rate and data flow between devices. In other words, a buffer is an area of physical memory storage used to store data temporarily."
},
{ // 2
    question: "What is the smallest unit of the information?",
    answers: ["A bit", "A byte", "A block", "A nibble"],
    correct: "A bit"
},
{ // 1
    question: "The word processing feature that catches most random typographical errors and misspellings is known as _____ .",
    answers: ["Grammar checker", "Spell checker", "Word checker", "None of these"],
